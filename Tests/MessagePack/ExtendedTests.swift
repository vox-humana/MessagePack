...
class ExtendedTests: XCTestCase {
    func testPackFixext1() {
        ...
        let packed: [Byte] = [0xd4, 0x05, 0x00]
    ...
    func testPackFixext2() {
        ...
        let packed: [Byte] = [0xd5, 0x05, 0x00, 0x01]
        XCTAssertEqual(pack(value), packed)
    }
    ...
    func testPackFixext4() {
        ...
        let packed: [Byte] = [0xd6, 0x05, 0x00, 0x01, 0x02, 0x03]
        XCTAssertEqual(pack(value), packed)
    }
    ...
    func testPackFixext8() {
        ...
        let packed: [Byte] = [0xd7, 0x05, 0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07]
        XCTAssertEqual(pack(value), packed)
    }
    ...
    func testPackFixext16() {
        ...
        let packed: [Byte] = [0xd8, 0x05, 0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0a, 0x0b, 0x0c, 0x0d, 0x0e, 0x0f]
        XCTAssertEqual(pack(value), packed)
    }
    ...
    func testPackExt8() {
        let payload = [Byte](repeating: 0, count: 7)
    ...
    func testPackExt16() {
        let payload = [Byte](repeating: 0, count: 0x100)
        let value = MessagePackValue.Extended(5, payload)
    ...
    func testPackExt32() {
        let payload = [Byte](repeating: 0, count: 0x10000)
        let value = MessagePackValue.Extended(5, payload)
